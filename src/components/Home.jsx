        ...
        <table className="border-collapse w-full">
          ...
          <tbody>
            {tasks
              ...
              .map((task, index) => (
                <tr
                  className="text-center border-b border-gray-300 bg-white hover:bg-gray-100 select-none"
                  key={index}
                >
                  <td className="text-center px-4  border border-gray-300 pl-2 py-3">
                    {task.name}
                  </td>
                  <td className="text-center  border-r border-gray-300 pl-2 py-3">
                    <span
                      className={` ${
                        task.priority === "High" &&
                        "bg-[#f44336] text-lg inline-block w-1/2 text-white px-3 py-1 rounded-2xl"
                      } ${
                        task.priority === "Medium" &&
                        "bg-[#ffc600] text-lg inline-block w-1/2  text-white px-3 py-1 rounded-2xl"
                      } ${
                        task.priority === "Low" &&
                        "bg-[#9e9e9e] text-lg inline-block w-1/2  text-white px-6 py-1 rounded-2xl"
                      }`}
                    >
                      {task.priority}
                    </span>
                  ...
                  <td className="text-center border-r border-gray-300 pl-2 py-3">
                    <span
                      className={`${
                        task.status === "Todo" &&
                        "bg-[#2196f3] text-lg inline-block w-1/2 text-white px-3 py-1 rounded-2xl"
                      } ${
                        task.status === "Done" &&
                        "bg-[#4caf50] text-lg inline-block w-1/2  text-white px-3 py-1 rounded-2xl"
                      } ${
                        task.status === "Doing" &&
                        "bg-[#ff9800] text-lg inline-block w-1/2 text-white px-3 py-1 rounded-2xl"
                      }`}
                    >
                      {task.status}
                    </span>
                  ...
                  <td className="text-center border-r border-gray-300 pl-2 py-3">
                    <span className=" inline-block w-full  text-lg  text-[#f44336] px-3 py-1 rounded-2xl">
                      {task.date}
                    </span>
                  </td>
                  <td>
